...
final public class Format {
    ...
    public static String dateFormat(Date date, String format) {
        SimpleDateFormat sdf = new SimpleDateFormat(format, new MainFormatSymbols());
        return sdf.format(date);
    }

    public static class MainFormatSymbols extends DateFormatSymbols {
        @Override
    ...
    public static String getTitleOfFilter(Filter filter) {
