...
import com.vivla.gui.handler.AddEditDialogHandler;
    ...
    private void setDialog() {
        ...
        for (Map.Entry<String, JComponent> entry : components.entrySet()) {
            ...
            if (component instanceof JTextField) {
                ...
                if (values.containsKey(key)) ((UtilDateModel) ((JDatePickerImpl) component).
        ...
        MainButton ok = new MainButton(Text.get("ADD"), Style.ICON_OK,
        ...
        MainButton cancel = new MainButton(Text.get("CANCEL"), Style.ICON_CANCEL,
