...
import com.vivla.gui.table.model.TransferTableModel;
...
public class TransferTableData extends TableData {
    ...
    private static final ImageIcon[] icons = new ImageIcon[]{Style.ICON_DATE,
            Style.ICON_ACCOUNT, Style.ICON_ACCOUNT,
